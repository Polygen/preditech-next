...
export default function OdemePage() {
  ...
  return (
    <div className="container" style={{ paddingTop: '140px', minHeight: '100vh' }}>
      <div className="checkout-container reveal" style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '40px', maxWidth: '1200px', margin: '0 auto', paddingBottom: '80px' }}>
        ...
        <div>
          ...
          <div className="checkout-card" style={{ marginBottom: '24px' }}>
            ...
            <div className="form-row">
              <div className="form-group">
                <label>Ad</label>
                <input type="text" className="sporty-input" placeholder="Adınız" />
              </div>
              <div className="form-group">
                <label>Soyad</label>
                <input type="text" className="sporty-input" placeholder="Soyadınız" />
              </div>
            </div>

            <div className="form-group" style={{ marginBottom: '16px' }}>
              <label>Açık Adres</label>
              <textarea className="sporty-input" style={{ height: '80px', resize: 'none' }} placeholder="Mahalle, sokak, bina no..."></textarea>
            </div>

            <div className="form-row">
              <div className="form-group">
                <label>İl</label>
                <input type="text" className="sporty-input" placeholder="İl" />
              </div>
              <div className="form-group">
                <label>İlçe</label>
                <input type="text" className="sporty-input" placeholder="İlçe" />
              </div>
            </div>
          </div>
          ...
          <div className="checkout-card">
            ...
            <div className="form-group" style={{ marginBottom: '16px' }}>
              ...
              <input type="text" className="sporty-input" placeholder="İSİM SOYİSİM" />
            </div>

            <div className="form-group" style={{ marginBottom: '16px' }}>
              <label>Kart Numarası</label>
              <input type="text" className="sporty-input" placeholder="0000 0000 0000 0000" maxLength={19} />
            </div>

            <div className="form-row">
              <div className="form-group">
                <label>Son Kullanma (AA/YY)</label>
                <input type="text" className="sporty-input" placeholder="12/26" maxLength={5} />
              </div>
              <div className="form-group">
                <label>CVV</label>
                <input type="text" className="sporty-input" placeholder="123" maxLength={3} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="checkout-card" style={{ position: 'sticky', top: '120px' }}>
            ...
            <button
              ...
              className="btn btn-primary sporty-btn"
              style={{ width: '100%', justifyContent: 'center', background: 'var(--accent)', color: '#000', fontWeight: '800', padding: '20px', fontSize: '16px' }}
            >
              GÜVENLİ ÖDEME YAP
            </button>
